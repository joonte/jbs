...
if(IsSet($Config['Notifies']['Settings']['ICQClient']['Uin'])){
	...
	$Server = Array(
			...
			'Notice'	=> 'Можно указать несколько UIN в поле "Логин" перечислив их через запятую. Для отсылки будет выбираться случайный из них. Пароль должен быть одинаковым.',
			'SortID'	=> 100000,
			'Monitoring'	=> 'ICQ=5190'
			);
	#-------------------------------------------------------------------------------
