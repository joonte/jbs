DELETE FROM `Clauses` WHERE `Partition` = 'Invoices/PaymentSystems/Individual/Individual';
-- SEPARATOR
set @Text = '<NOBODY>
...
-- SEPARATOR
DELETE FROM `Clauses` WHERE `Partition` = 'Invoices/PaymentSystems/Individual/Juridical';
-- SEPARATOR
set @Text = '<NOBODY>
 <DIV id="Logo">[логотип]</DIV>
 <P>
