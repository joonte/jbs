 ...
 <TR>
  ...
  <TR>
   <TD class="Standard" colspan="2" style="background-color:#FCE5CC;">
    ...
    Если планируется настройка оповещений по ICQ, то лучше запустить планировщик в режиме демона - для чего добавьте в crontab такую строку:
...
EOD;
  #-----------------------------------------------------------------------------
  echo SPrintF($Echo,HOST_ID,$_SERVER["DOCUMENT_ROOT"]);
}
#-------------------------------------------------------------------------------
?>
