...
(50000, 2000000, 1, 1100, 'Поддержка заказа дополнительного IP адреса', 'IP адрес', 'ExtraIP', 'IP адреса', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 5100),
(51000, 2000000, 1, 1100, 'Заказ программного обеспечения ISPsystems', 'ПО ISPsystem', 'ISPsw', 'Лицензии ISPsystem', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 5200),
(52000, 2000000, 1, 1100, 'Вторичный DNS', 'Вторичный DNS', 'DNSmanager', 'Вторичный DNS', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 5300),
(52000, 2000000, 1, 1100, 'Прокси-сервер', 'Прокси', 'Proxy', 'Прокси-сервер', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 5400);
