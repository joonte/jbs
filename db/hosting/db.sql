...
(20000, 2000000, 1, 1000, 'Поддержка заказа домена', 'Домены', 'Domain', 'Домены', 'год', 'Yearly', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 20),
(30000, 2000000, 1, 1000, 'Поддержка заказа виртуального сервера', 'Виртуальный сервер', 'VPS', 'Виртуальный сервер', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 20),
(40000, 2000000, 1, 1000, 'Поддержка заказа выделенного сервера', 'Выделенный сервер', 'DS', 'Выделенный сервер', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 30),
