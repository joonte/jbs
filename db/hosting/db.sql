...
INSERT INTO `Services` (`ID`, `GroupID`, `UserID`, `ServicesGroupID`, `Name`, `NameShort`, `Code`, `Item`, `Measure`, `ConsiderTypeID`, `CostOn`, `Cost`, `IsHidden`, `IsProtected`, `IsActive`, `IsProlong`, `Priority`, `SortID`) VALUES
(10000, 2000000, 1, 1000, 'Поддержка заказа хостинга', 'Хостинг', 'Hosting', 'Хостинг', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 300, 10),
(20000, 2000000, 1, 1000, 'Поддержка заказа домена', 'Домены', 'Domain', 'Домены', 'год', 'Yearly', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 999, 20),
(30000, 2000000, 1, 1000, 'Поддержка заказа виртуального сервера', 'Виртуальный сервер', 'VPS', 'Виртуальный сервер', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 300, 20),
(40000, 2000000, 1, 1000, 'Поддержка заказа выделенного сервера', 'Выделенный сервер', 'DS', 'Выделенный сервер', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 300, 30),
(50000, 2000000, 1, 1100, 'Поддержка заказа дополнительного IP адреса', 'IP адрес', 'ExtraIP', 'IP адреса', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 10),
(51000, 2000000, 1, 1100, 'Заказ программного обеспечения ISPsystems', 'ПО ISPsystem', 'ISPsw', 'Лицензии ISPsystem', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 20),
(52000, 2000000, 1, 1100, 'Вторичный DNS', 'Вторичный DNS', 'DNSmanager', 'Вторичный DNS', 'дн.', 'Daily', 0.00, 0.00, 'no', 'yes', 'yes', 'yes', 100, 52000);
UNLOCK TABLES;
