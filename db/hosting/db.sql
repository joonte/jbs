...
VALUES (4,100,100, 'Contracts/Enclosures/Types/VPSRules/Content', 'Регламент предоставления услуг VPS', 'no', 'yes', 'yes', '<NOBODY>
 ...
 <table style="width: 100%;">
  <tbody>
   <tr>
    <td valign="top">2.10.</td>
    <td align="justify" width="95%">В случае восстановления удалённого заказа из резервной копии, при возврате денежных средств, удерживается сумма эквивалентная стоимости четырёх месяцев по тарифу Заказчика.</td>
   </tr>
  </tbody>
 </table>
 <H2>
