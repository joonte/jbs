...
<tbody>
	<tr>
		<td valign="top">3.7. При изменении данных, указанных при регистрации или иных данных сообщенных Заказчиком посредством АСУ, Заказчик, так же при помощи АСУ, обязан уведомить Исполнителя в срок не более 7 (семи) дней с момента изменения.</td>
	<tr>
</tbody>
</table>
...
<tbody>
	<tr>
		<td valign="top">4.3. Заявка должна иметь все необходимые реквизиты для точной идентификации Заказчика, а так же должны быть точно и ясно сформулированы задачи, требующие исполнения.</td>
	<tr>
</tbody>
</table>
<table style="width: 100%;">
...
<tbody>
	<tr>
		<td valign="top">4.5.<table style="width: 100%;">
<tbody>
	<tr>
		<td valign="top">Все заявки по электронной почте должны отправляться в одной из кодировок WINDOWS-1251, KOI8-R, UTF-8, в области символов ранее означенных кодировок в формате, определенным RFC-822.</td>
	<tr>
</tbody>
</table>
<table style="width: 100%;">
...
<tbody>
	<tr>
		<td valign="top">6.9. Исполнитель высылает оригиналы бухгалтерских документов Заказчику по почтовому адресу, указанному Заказчиком посредством АСУ, или вручает сотруднику заказчика в офисе Исполнителя.</td>
	<tr>
</tbody>
</table>
<table style="width: 100%;">
...
<tbody>
	<tr>
		<td valign="top">6.13 Исполнитель в праве в одностороннем порядке изменять стоимость и параметры предоставляемых услуг, о чем обязан извещать Заказчика не позднее, чем за 7 (семь) календарных дней до вступления изменений в силу и опубликовать указанные изменения в блоке тарифов на своем WEB-сервере.</td>
	<tr>
</tbody>
</table>
