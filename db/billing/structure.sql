...
CREATE TABLE `Services` (
  ...
  `PartnersRewardPercent` DOUBLE NOT NULL DEFAULT '0',
...
/* временные данные, номера чеков, ссылки сбербанка, номера сообщений телеги, ВК ... */
...
/* ресурсы хостинга, ВПС, выделенных серверов */
