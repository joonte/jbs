...
function MobileConfirmCheck() {
	...
	switch ($Answer.Status) {
		...
		break;
	    case 'Ok':
		ShowAlert('Номер телефона успешно подтвержден, и теперь вам доступны настройки SMS уведомлений во вкладке "Уведомления". Все предыдущие настройки для SMS были сброшены');
		break;
	    default:
