...
function HideWindowByEsc(){
	...
	if(document.getElementById('Confirm')){
		...
		//------------------------------------------------------------------------------
		// тут же обработка списочных меню, т.к. и одно и другое не удаляется, просто прячется
		if(document.getElementById('ListMenu').style.display == 'block'){
			//------------------------------------------------------------------------------
			ListMenuHide();
			//------------------------------------------------------------------------------
			return;
		...
		//------------------------------------------------------------------------------
		// окно закрыто, открываем обратно
