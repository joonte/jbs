...
<HTML>
 ...
 <BODY>
  <TABLE class="Standard" cellspacing="5" cellpadding="0" style="max-width:600px;">
   <CAPTION>Установка биллинговой системы Joonte Billing System 2007-2011</CAPTION>
EOD;
...
if($__STEP_ID == 1){
  ...
  if(IsSet($MySQLbin)){
    ...
    $Test = Array('Status'=>'Не найдено','IsOk'=>FALSE,'Comment'=>'Приложение mysql не найдено. Пожалуйста, воспользуйтесь менеджером пакетов для установки данной программы <A target="blank" href="http://wiki.joonte.com/?title=Подготовка_к_установке">[подробнее...]</A>');
  #-----------------------------------------------------------------------------
 ...
 <TR>
  ...
  <TR>
   <TD class="Standard" colspan="2" style="background-color:#FCE5CC;">
    ...
    После входа в систему воспользуйтесь руководством <A target="blank" href="http://wiki.joonte.com/index.php?title=Первый_запуск_системы">[первый запуск]</A>.
    <BR />
