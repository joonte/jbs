 ...
 *}
{assign var=Theme value="Перенос домена" scope=global}
Здравствуйте, {$User.Name|default:'$User.Name'}!

Уведомляем Вас о том, что {$StatusDate|default:'$StatusDate'} от Вас поступила заявка на перенос домена №{$OrderID|string_format:"%05u"} ({$DomainName|default:'$DomainName'}.{$Name|default:'$Name'}) под наше управление.
