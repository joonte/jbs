...
Уведомляем Вас о том, что {$smarty.now|date_format:"%d.%m.%Y"} пароль на Ваш заказ виртуального выделенного сервера (ExtraIP) №{$Params.Item.OrderID|string_format:"%05u"} был успешно изменен.
