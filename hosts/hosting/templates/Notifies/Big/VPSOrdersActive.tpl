 ...
 *}
{assign var=Theme value="Активирован заказ виртуального сервера #{$OrderID|string_format:"%05u"}, IP ({$IP|default:'$IP'})" scope=global}
...
---
Обращаем ваше внимание, что в некоторых реализациях виртуализации KVM смена тарифа на больший не приводит к автоматическому изменению размера диска, видимого операционной системой. Для применения настроек, необходимо перезагрузить виртуальный сервер (Ctrl+Alt+Del в сессии VNC) и изменить размер диска средствами операционной системы.
