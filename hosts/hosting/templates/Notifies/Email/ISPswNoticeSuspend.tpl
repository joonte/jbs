...
Уведомляем Вас о том, что оканчивается срок действия Вашего заказа №{$Item.OrderID|string_format:"%05u"} на ПО ISPsystem.
До окончания заказа {$Item.DaysRemainded|default:'$Item.DaysRemainded'} дн.
IP адрес заказа: {$Item.IP|default:'$Item.IP'}.
