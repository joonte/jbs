...
function VmManager5_CheckIsActive($Settings,$Login){
	...
	#-----------------------------------------------------------------------------
	$Response = Http_Send('/vmmgr',$Http,Array('authinfo'=>$authinfo,'out'=>'xml','func'=>'vds'));
	if(Is_Error($Response))
...
function VmManager5_Reboot($Settings,$Login){
	...
	#-----------------------------------------------------------------------------
	$Response = Http_Send('/vmmgr',$Http,Array('authinfo'=>$authinfo,'out'=>'xml','func'=>'vds.reboot','elid'=>$Login));
	if(Is_Error($Response))
