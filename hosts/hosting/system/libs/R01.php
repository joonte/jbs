  ...
  switch($PepsonID){
    case 'Natural':
      ...
      $Response = $AddCustomer->addDadminPerson(
        ...
        $Person['BornDate'],
        SPrintF('%d, %s, %s, %s, %s', $Person['pIndex'], $Person['pCountry'], $Person['pState'], $Person['pCity'], $Person['pAddress']),
        $Person['Phone'],
        $Person['Fax'],
        $Person['Email'],
        1,
    ...
    case 'Juridical':
      ...
      $Response = $AddCustomer->addDadminOrg(
        ...
        $Person['Inn'],
        $Person['Ogrn'],
        SPrintF('%d, %s, %s, %s, %s', $Person['jIndex'], $Person['jCountry'], $Person['jState'], $Person['jCity'], $Person['jAddress']),
        SPrintF('%d, %s, %s, %s, %s', $Person['jIndex'], $Person['jCountry'], $Person['jState'], $Person['jCity'], $Person['pAddress']),
        $Person['Phone'],
        $Person['Fax'],
        $Person['Email'],
