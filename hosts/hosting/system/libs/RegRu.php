...
function RegRu_Domain_Transfer($Settings,$DomainName,$DomainZone,$Param){
	...
	#-------------------------------------------------------------------------------
	// 2026-05-20, период обязательным стал для указания
	$Query['period'] = (In_Array($DomainZone,Array('ru','su','рф')))?0:1;
	#-------------------------------------------------------------------------------
	...
	#-------------------------------------------------------------------------------
	#-------------------------------------------------------------------------------
	$Query['ns0'] = $Param['Ns1Name'];
	$Query['ns1'] = $Param['Ns2Name'];
	#-------------------------------------------------------------------------------
	if($Param['Ns1IP'] && $Param['Ns2IP']){
		#-------------------------------------------------------------------------------
//		$Query['nss[0]'] = $Param['Ns1IP'];
//		$Query['nss[1]'] = $Param['Ns2IP'];
		$Query['ns0']	= $Param['Ns1IP'];
		$Query['ns1']	= $Param['Ns2IP'];
		#-------------------------------------------------------------------------------
	}
	#-------------------------------------------------------------------------------
