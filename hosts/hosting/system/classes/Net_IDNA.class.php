 ...
 * @package Net
 * @version $Id: IDNA.php 300850 2010-06-29 09:47:19Z neufeind $
 */
class Net_IDNA
{
    // {{{ npdata
                ...
                if ($decoded[$i] < $cur_code) {
                    ...
                    for ($q = $delta, $k = $this->_base; 1; $k += $this->_base) {
                        $t = ($k <= $bias) ? $this->_tmin :
                                (($k >= $bias + $this->_tmax) ? $this->_tmax : $k - $bias);
                        if ($q < $t) break;
                        $encoded .= $this->_encode_digit(ceil($t + (Floor($q - $t) % ($this->_base - $t))));
                        $q = ($q - $t) / ($this->_base - $t);
                    }
 ...
 * @deprecated
 */
class Net_IDNA_php4 extends Net_IDNA {}
