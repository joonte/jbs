...
Уведомляем Вас о том, что %ISPswOrder.StatusDate% Ваш заказ №%ISPswOrder.Number% на ПО ISPsystem, IP адрес %ISPswOrder.IP%, был заблокирован.
...
#-------------------------------------------------------------------------------
return Array('Theme'=>'Заказ программного обеспечения заблокирован','Message'=>$Message);
#-------------------------------------------------------------------------------
