...
Уведомляем Вас о том, что %DomainOrder.StatusDate% Ваш заказ №%DomainOrder.Number% на регистрацию домена [%DomainOrder.DomainName%.%DomainOrder.Name%] был удален.
...
#-------------------------------------------------------------------------------
return Array('Theme'=>'Заказ домена удален','Message'=>$Message);
#-------------------------------------------------------------------------------
