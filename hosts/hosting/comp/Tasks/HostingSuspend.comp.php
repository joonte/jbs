    ...
    switch(ValueOf($IsSelected)){
      ...
      case 'true':
	    ...
	    $Event = Array(
				...
				'PriorityID'	=> 'Hosting',
				'Text'		=> SPrintF('Заказ хостинга логин [%s], домен (%s), тариф (%s) заблокирован на сервере (%s)',$HostingOrder['Login'],$HostingOrder['Domain'],$HostingOrder['SchemeName'],$ClassHostingServer->Settings['Address'])
	                  );
