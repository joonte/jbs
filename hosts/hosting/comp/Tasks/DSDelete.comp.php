...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
$IsDelete = Call_User_Func_Array(Array($ClassDSServer,'Delete'),Array($DSScheme));
#-------------------------------------------------------------------------------
...
$Event = Array(
		...
		'PriorityID'	=> 'Billing',
		'Text'		=> SPrintF('Удалён арендованный сервер, заказ #%s, тариф (%s), IP адрес %s',$DSOrder['OrderID'],$DSScheme['Name'],$DSOrder['IP'])
		);
#-------------------------------------------------------------------------------
