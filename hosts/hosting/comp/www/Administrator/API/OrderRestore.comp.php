      ...
      case 'array':
        ...
        if($SummRemainded){
          ...
          if(Is_Error($Comp))
            return ERROR | @Trigger_Error(500);
          #---------------------------------------------------------------------
          $IsUpdate = Comp_Load('www/Administrator/API/PostingMake',Array('ContractID'=>$Order['ContractID'],'Summ'=>$SummRemainded,'ServiceID'=>3000,'Comment'=>SPrintF('Заказ хостинга №%s',$Comp)));
          #---------------------------------------------------------------------
