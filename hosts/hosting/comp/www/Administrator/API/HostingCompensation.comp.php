...
#-------------------------------------------------------------------------------
$HostingOrders = DB_Select('HostingOrders',Array('ID','OrderID','(SELECT `CostDay` FROM `HostingSchemes` WHERE `HostingSchemes`.`ID` = `HostingOrders`.`SchemeID`) as `CostDay`'),$HostingOrderID?Array('ID'=>$HostingOrderID):Array('Where'=>SPrintF("`ServerID` = %u AND `StatusID` = 'Active'",$HostingServerID)));
#-------------------------------------------------------------------------------
