...
$IsAutoBalanced		=( boolean) @$Args['IsAutoBalanced'];
...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
/* потеряло смысл в связи с реализацией JBS-1449
 * TODO: надо подтверждение или ялярм какой-то что зона без описания, используется стандартное
