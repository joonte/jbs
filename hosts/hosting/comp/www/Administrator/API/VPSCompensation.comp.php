...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
$VPSOrders = DB_Select('VPSOrdersOwners',Array('ID','OrderID','(SELECT `CostDay` FROM `VPSSchemes` WHERE `VPSSchemes`.`ID` = `VPSOrdersOwners`.`SchemeID`) as `CostDay`'),$VPSOrderID?Array('ID'=>$VPSOrderID):Array('Where'=>SPrintF("(SELECT `ServerID` FROM `OrdersOwners` WHERE `VPSOrdersOwners`.`OrderID` = `OrdersOwners`.`ID`) = %u AND `StatusID` = 'Active'",$ServerID)));
#-------------------------------------------------------------------------------
