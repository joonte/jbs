...
$Comp = Comp_Load(
		...
		Array(
			...
			'prompt'=> 'Шаблон используемый при создании виртуальной машины. Значение передаётся только если задано, шаблоны могут использоваться для назначений хранлища виртуальной машины - HDD, SDD, iSCSI и т.п.',
			'style' => 'width: 100%;',
			)
		);
if(Is_Error($Comp))
