...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
$Comp = Comp_Load('Form/Input',Array('type'=>'text','name'=>'DependOrder','value'=>$ExtraIPOrder['DependOrder'],'style'=>'width: 100%;','prompt'=>'Логин для заказа хостинга/VPS или номер заказа для выделенного сервера'));
if(Is_Error($Comp))
	return ERROR | @Trigger_Error(500);
#-------------------------------------------------------------------------------
