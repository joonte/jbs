...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
// проверяем, если внутренний тариф - должен быть задан DependOrderID
if($ISPswScheme['IsInternal'] && $IP)
	return new gException('SCHEME_INTERNAL_ONLY','Выбранный тарифный план только для заказа с нашими выделенными и виртуальными серверами');
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
