...
if($OrderID && !$SchemeChange)
        $DOM->AddAttribs('Body',Array('onload'=>SPrintF("ShowWindow('/ISPswOrderPay',{OrderID:'%u'});",$OrderID)));
#-------------------------------------------------------------------------------
if($OrderID && $SchemeChange)
	$DOM->AddAttribs('Body',Array('onload'=>SPrintF("ShowWindow('/ISPswOrderSchemeChange',{OrderID:'%u'});",$OrderID)));
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
