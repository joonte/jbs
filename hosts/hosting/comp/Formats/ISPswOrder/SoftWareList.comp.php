...
$ISPswList =  Array(
			'7:7'		=> 'ISPmanager Lite [без поддержки] триал',
			'7:8'		=> 'ISPmanager Lite [без поддержки] 1 месяц',
			'7:9'		=> 'ISPmanager Lite [без поддержки] вечная',
			'11:15'		=> 'ISPmanager Pro [без поддержки] триал',
			'11:16'		=> 'ISPmanager Pro [без поддержки] 1 месяц',
			'11:17'		=> 'ISPmanager Pro [без поддержки] вечная',
			...
			'17:30'		=> 'DNSmanager триал',
			'17:31'		=> 'DNSmanager вечная',
			'18:32'		=> 'IPmanager триал',
			'18:33'		=> 'IPmanager вечная',
	);
