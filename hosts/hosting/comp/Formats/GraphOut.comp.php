...
if(IsSet($Params['Graphs'])){
	...
	foreach(Array_Keys($Template) as $Key){
		...
		#-------------------------------------------------------------------------------
		// TODO
		// если период не сутки, то делим его на 48 частей.
		// внутри каждой части суммируем данные и делим на число частей
		// на этом этапе в массив собраны все данные за нужный период
		// считаем число точек, делим период на 48 частей
		// внутри каждого под-периода считаем среднее значение
		#-------------------------------------------------------------------------------
		#-------------------------------------------------------------------------------
	}
	#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
// если нужен только AlertID - достаём максимальный и возвращаем его
if($IsAlert){
