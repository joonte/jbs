...
$Tr = new Tag('TR');
#-------------------------------------------------------------------------------
$DSSchemes = DB_Select('DSSchemes',Array('ID','Name','CostMonth','(SELECT `Name` FROM `ServersGroups` WHERE `ID` = (SELECT `ServersGroupID` FROM `Servers` WHERE `Servers`.`ID` = `DSSchemes`.`ServerID`)) as `ServersGroupName`'),Array('SortOn'=>'Name'));
#-------------------------------------------------------------------------------
