...
История операций по договору: {$smarty.const.URL_SCHEME|default:'URL_SCHEME'}://{$smarty.const.HOST_ID|default:'HOST_ID'}/v2/Postings?ContractID={$ContractID|default:'$ContractID'}
Ваши счета на оплату: {$smarty.const.URL_SCHEME|default:'URL_SCHEME'}://{$smarty.const.HOST_ID|default:'HOST_ID'}/v2/Invoices
