...
while($DaysRemainded){
	...
	case 'array':
		...
		#-------------------------------------------------------------------------------
		# по идее, весь этот файл должен работать внутри транзакции, вместе с Services/Politics
		# однако, в JBS-940 он дёргается прям так, просто без указания $OrderID
		# и у юзеров списываются бонусы... при простой оценке стоимости, без реальной оплаты
		if($OrderID){
			#-------------------------------------------------------------------------------
