...
#-------------------------------------------------------------------------------
// меняем мдентфикатор у первого Title, который ещё в "<head>"
// нужно для сокрытия следующего, т.к. у них одинаковый идентфикатор
$Title->AddAttribs(Array('id'=>'TitleOnPage'),TRUE);
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
