...
#-------------------------------------------------------------------------------
$Cache = Array(
		'Confirm1'	=> SPrintF('c1-%s-%s-%s',$Method,$Value,$__USER['ID']),
		'Confirm2'	=> SPrintF('c2-%s-%s-%s',$Method,$Value,$__USER['ID']),
...
if(!$Confirm && !$Code){
	...
	#-------------------------------------------------------------------------------
	$Url = SPrintF('http://%s/API/Confirm?Method=%s&Value=%s&Code=%s',HOST_ID,$Method,$Value,$Confirm2);
	#-------------------------------------------------------------------------------
