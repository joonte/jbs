...
#-------------------------------------------------------------------------------
$Comp = Comp_Load('Form/Select',Array('name'=>'EdesksDisplay','prompt'=>'Как отображать в системе поддержки автары и текст'),Array('Right'=>'Правое','Left'=>'Левое'),IsSet($_COOKIE['EdesksDisplay'])?$_COOKIE['EdesksDisplay']:'Left');
if(Is_Error($Comp))
	return ERROR | @Trigger_Error(500);
#-------------------------------------------------------------------------------
$Table[] = Array('Положение текста относительно',$Comp);
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
