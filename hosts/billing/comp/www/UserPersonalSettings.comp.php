...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
#$Comp = Comp_Load('Form/Select',Array('name'=>'SMSBeginTime','prompt'=>'Время начала рассылки SMS сообщений'),Array(''=>'','Left'=>'Левое'),$GLOBALS['__USER']['SMSBeginTime'];);
#if(Is_Error($Comp))
#	return ERROR | @Trigger_Error(500);
#-------------------------------------------------------------------------------
#$Table[] = Array('Начало рассылки',$Comp);
