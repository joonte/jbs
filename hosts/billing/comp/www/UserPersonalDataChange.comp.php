...
foreach($__USER['Contacts'] as $Contact){
	...
	if($Contact['IsPrimary']){
		#-------------------------------------------------------------------------------
		$IsPrimary = SPrintF("ShowAlert('Этот адрес (%s/%s) удалить нельзя, т.к. он используется для входа в биллинг. Для удаления, вначале назначьте другой адрес в качестве логина','Warning')",$Contact['MethodID'],$Contact['Address']);
		#-------------------------------------------------------------------------------
	}else{
		#-------------------------------------------------------------------------------
		$IsPrimary = SPrintF("ShowConfirm('Вы подтверждаете удаление контакта (%s/%s)?','ContactDelete(%s);');",$Contact['MethodID'],$Contact['Address'],$Contact['ID']);
		#-------------------------------------------------------------------------------
	}
	#-------------------------------------------------------------------------------
	#-------------------------------------------------------------------------------
