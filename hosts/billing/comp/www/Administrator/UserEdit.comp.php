...
#-------------------------------------------------------------------------------
$Comp = Comp_Load('Form/Summ',Array('name'=>'LayPayThreshold','value'=>$User['LayPayThreshold'],'prompt'=>'Сумма оплаченных счетов, начиная с которой у пользователя появится возможность прводить счета условно'));
if(Is_Error($Comp))
  return ERROR | @Trigger_Error(500);
#-------------------------------------------------------------------------------
