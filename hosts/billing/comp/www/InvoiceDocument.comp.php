	...
	case 'array':
		...
		foreach ($Services as $Service){
			...
			if(IsSet($Settings[$Service['Code']])){
				...
				#-------------------------------------------------------------------------------
				if(!$IsConfirmed)
					$Message = "Для оплаты и активации заказанной услуги требуется подтверждённый почтовый адрес. Нажмите \"Настройки\" и подтвердите ваш почтовый адрес";
				#-------------------------------------------------------------------------------
				#-------------------------------------------------------------------------------
				$IsConfirmed = FALSE;
				#-------------------------------------------------------------------------------
				...
				#-------------------------------------------------------------------------------
				if(!$IsConfirmed)
					$Message = "Для оплаты и активации заказанной услуги требуется подтверждённый номер мобильного телефона (SMS). Нажмите \"Настройки\", добавьте контакт \"SMS-сообщения\" и подтвердите ваш телефон";
				#-------------------------------------------------------------------------------
			}
			#-------------------------------------------------------------------------------
		}
