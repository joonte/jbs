...
#-------------------------------------------------------------------------------
if($IsMobile || (IsSet($_COOKIE['hScreen']) && $_COOKIE['hScreen'] < 550) || (IsSet($_COOKIE['wScreen']) && $_COOKIE['wScreen'] < 950)){
	#-------------------------------------------------------------------------------
	Debug(SprintF('[comp/TopPanel]: детектирован мобильный девайс, $IsMobile = %s; wScreen = %s; hScreen = %s',($IsMobile)?'TRUE':'FALSE',@$_COOKIE['wScreen'],@$_COOKIE['hScreen']));
	#-------------------------------------------------------------------------------
	...
	#-------------------------------------------------------------------------------
	Debug(SprintF('[comp/TopPanel]: НЕ мобильный девайс, $IsMobile = %s; wScreen = %s; hScreen = %s',($IsMobile)?'TRUE':'FALSE',@$_COOKIE['wScreen'],@$_COOKIE['hScreen']));
	#-------------------------------------------------------------------------------
}
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
