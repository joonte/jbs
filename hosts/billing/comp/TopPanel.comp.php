...
if(IsSet($GLOBALS['__USER']['ID'])){
	#-------------------------------------------------------------------------------
	#Debug(SPrintF('[comp/TopPanel]: User = %s',print_r($GLOBALS['__USER'],true)));
	#-------------------------------------------------------------------------------
	$Array = Array(
			'type'		=> 'text/javascript',
			'src'		=> 'SRC:{others/Another.js}',
			'UserID'	=> $GLOBALS['__USER']['ID'],
			'RegisterDate'	=> $GLOBALS['__USER']['RegisterDate'],
			'Email'		=> $GLOBALS['__USER']['Email'],
			'InvoicesAmount'=> $GLOBALS['__USER']['InvoicesAmount'],
			);
	#-------------------------------------------------------------------------------
	$Links['DOM']->AddChild('Head',new Tag('SCRIPT',$Array));
	#-------------------------------------------------------------------------------
}
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
...
if(!IsSet($GLOBALS['__USER'])){
	...
	*/
	...
	#-------------------------------------------------------------------------------
	#-------------------------------------------------------------------------------
	// тока для администратора, у юзеров свой страница где всё это покaзано
	if($__USER['InterfaceID'] == 'Administrator'){
		#-------------------------------------------------------------------------------
	...
	#-------------------------------------------------------------------------------
	$A = new Tag('A',Array('class'=>'Button','title'=>'Выход из системы','href'=>'#','OnClick'=>"ShowConfirm('Вы действительно хотите выйти из системы?','Logout();');return false;"),'Выход');
	#-------------------------------------------------------------------------------
