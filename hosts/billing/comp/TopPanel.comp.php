...
if(IsSet($_COOKIE['hScreen']) && $_COOKIE['hScreen'] < 550){
	#-------------------------------------------------------------------------------
	Debug(SprintF('[comp/TopPanel]: детектировано устройство с низким вертикальным разрешением, $IsMobile = %s; wScreen = %s; hScreen = %s',($IsMobile)?'TRUE':'FALSE',@$_COOKIE['wScreen'],@$_COOKIE['hScreen']));
	#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
Debug(SprintF('[comp/TopPanel]: проверка мобильного устройства, IP = %s; $IsMobile = %s; wScreen = %s; hScreen = %s',@$_SERVER['REMOTE_ADDR'],($IsMobile)?'TRUE':'FALSE',@$_COOKIE['wScreen'],@$_COOKIE['hScreen']));
#-------------------------------------------------------------------------------
if($IsMobile || (IsSet($_COOKIE['wScreen']) && $_COOKIE['wScreen'] < 950)){
/*
#-------------------------------------------------------------------------------
