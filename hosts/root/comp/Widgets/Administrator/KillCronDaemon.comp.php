...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
$TaskNowRunning = SPrintF('%s/hosts/%s/tmp/TaskNowRunning.txt',SYSTEM_PATH,HOST_ID);
#-------------------------------------------------------------------------------
...
$Comp = Comp_Load(
		...
		Array(
			'type'		=> 'button',
			'onclick'	=> "AjaxCall('/Administrator/API/KillCronDaemon',{IsKill:1},'Убиение планировщика','ShowTick(\"Планировщик убит\");');",
